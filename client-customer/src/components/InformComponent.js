    ...
    return (
      <div className="border-bottom">
        ...
        {this.context.token === '' ?
          ...
          :
          <div>Hello <b>{this.context.customer.name}</b> | <Link to='/home' onClick={() => this.lnkLogoutClick()}>Logout</Link> | <Link to=''>My profile</Link> | <Link to='/myorders'>My orders</Link></div>
        }
        </div>
